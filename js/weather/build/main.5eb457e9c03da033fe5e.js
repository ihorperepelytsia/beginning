  ...
  [0],
  {
    ...
    QfWi: function (e, t, a) {
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 3:
                      (t = e.sent), console.log(t), i(t.data), (e.next = 11);
                      break;
                    case 8:
                      (e.prev = 8),
                        (e.t0 = e.catch(0)),
      ...
      const f = e => {
        ...
        b = new Date(v.getTime() + 3456e5).getDate();
      function D(e) {
        const t = e.list.map(t => ({
            day: _(1e3 * +t.dt - 1e3 * +e.city.timezone),
            month: L(1e3 * +t.dt - 1e3 * +e.city.timezone),
      ...
      var B = a('9AbI'),
        ...
        q = a.n(I);
      function M(e) {
        o.moreInfo.insertAdjacentHTML('beforeend', q()(e));
      }
      ...
      async function H(e) {
        ...
        try {
          ...
          (t = D(a)),
            o.fiveDaysWeather.insertAdjacentHTML('beforeend', O()(t)),
            (function (e) {
              ...
              new W.a(document.getElementById('myChart'), t);
            })(D(a));
        } catch (e) {
          Object(s.error)({ text: 'Ooops! ' + e.message });
        }
      ...
      async function R(e) {
        ...
        try {
          ...
          l(t.data), 'OK' === t.statusText && p(e), y();
        } catch (e) {
          Object(s.error)({ text: 'No city found with this name' }), y();
        }
      }
      function z(e, t, a, n, r, o, i) {
        try {
          var s = e[o](i),
            d = s.value;
        } catch (e) {
      ...
      void 0 !== f('locationCity') &&
        (R(f('locationCity')), p(f('locationCity')), H(f('locationCity'))),
...
//# sourceMappingURL=main.5eb457e9c03da033fe5e.js.map
