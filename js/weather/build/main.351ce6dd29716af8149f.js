    ...
    QfWi: function (e, t, a) {
      ...
      function i(e) {
        ...
        setInterval(() => {
          t < 49 &&
            ((t += 1),
            (o.quoteText.textContent = e[t].q),
            (o.quoteOwner.textContent = e[t].a));
        }, 8e3);
      }
      var s = a('QJ3N');
      ...
      var u = 'https://cors-anywhere.herokuapp.com/',
        l = 'https://zenquotes.io/api/quotes';
      function m() {
        return (m = c(
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (e.prev = 0), (e.next = 3), r.a.get('' + u + l);
                    case 3:
                      i(e.sent.data), (e.next = 10);
                      break;
                    case 7:
                      (e.prev = 7),
                        (e.t0 = e.catch(0)),
      ...
      const p = e => {
        ...
        C = new Date(),
        A = C.getDate(),
        S = new Date(C.getTime() + 864e5).getDate(),
        D = new Date(C.getTime() + 1728e5).getDate(),
        b = new Date(C.getTime() + 2592e5).getDate(),
        x = new Date(C.getTime() + 3456e5).getDate();
      function w(e) {
        const t = e.list.map(t => ({
            day: T(1e3 * +t.dt - 1e3 * +e.city.timezone),
            month: B(1e3 * +t.dt - 1e3 * +e.city.timezone),
          ...
          o = t.filter(e => {
            if (e.date === b) return e;
          }),
          i = t.filter(e => {
            if (e.date === x) return e;
          });
        (a[0].temp_min = _(a)),
          (n[0].temp_min = _(n)),
          (r[0].temp_min = _(r)),
      ...
      var I = a('9AbI'),
        ...
        W = a.n(M);
      function k(e) {
        o.moreInfo.insertAdjacentHTML('beforeend', W()(e));
      }
      ...
      var H = new Date(),
        j = [
          ...
          new Date(H.getTime() + 864e5).toLocaleDateString(),
          new Date(H.getTime() + 1728e5).toLocaleDateString(),
          new Date(H.getTime() + 2592e5).toLocaleDateString(),
          new Date(H.getTime() + 3456e5).toLocaleDateString(),
        ];
      async function Q(e) {
        void 0 === e && (e = 'lviv');
        try {
          const a = (
            await r.a.get(`${R}/forecast?q=${e}&appid=${z}&units=metric`)
          ).data;
          (t = w(a)),
            o.fiveDaysWeather.insertAdjacentHTML('beforeend', q()(t)),
            (function (e) {
              ...
              new E.a(document.getElementById('myChart'), t);
            })(w(a));
        } catch (e) {
          Object(s.error)({ text: 'Ooops! ' + e.message });
        }
      ...
      o.fiveDaysWeather.addEventListener('click', async e => {
        try {
          const t = o.fiveDaysCity.textContent.split(',')[0],
            a = await r.a.get(`${R}/forecast?q=${t}&appid=${z}&units=metric`);
          setTimeout(() => {
            ...
            (function (e, t) {
              ...
              if (a === b) {
                ...
                o.moreInfo.children.length > 0 &&
                +o.moreInfo.firstChild.dataset.day === b
                  ? (r(),
                    setTimeout(function () {
                      o.moreInfo.innerHTML = '';
                    }, 500))
              ...
              if (a === x) {
                ...
                o.moreInfo.children.length > 0 &&
                +o.moreInfo.firstChild.dataset.day === x
                  ? (r(),
                    setTimeout(function () {
                      o.moreInfo.innerHTML = '';
                    }, 500))
      ...
      const R = 'https://api.openweathermap.org/data/2.5',
        z = '3011adb88aa27a1ff044f2f136f6121c';
      async function J(e) {
        void 0 === e && (e = 'krakow');
        try {
          f();
          const t = await r.a.get(
            `${R}/weather?q=${e}&appid=${z}&units=metric`,
          );
          y(t.data), 'OK' === t.statusText && g(e), h();
        } catch (e) {
          Object(s.error)({ text: 'No city found with this name' }), h();
        }
      }
      function F(e, t, a, n, r, o, i) {
        try {
          var s = e[o](i),
            d = s.value;
        } catch (e) {
      ...
      void 0 !== p('locationCity') &&
        (J(p('locationCity')), g(p('locationCity')), Q(p('locationCity'))),
        o.btnLocation.addEventListener('click', function () {
          try {
            ...
            h(), Object(s.error)({ text: 'Ooops! ' + e.message });
          }
        });
      a('hi3g'), a('Xlt+'), a('C4nn');
      var P = a('Such'),
        ...
        o.addStarCityButton.addEventListener('click', function () {
          ...
          e.length > 0
            ? t
              ...
              : (o.searchStarContainer.insertAdjacentHTML('beforeend', Y()(e)),
                K.push(e),
                v('Star city', K),
      ...
      var K = [];
      void 0 !== p('Star city') &&
        p('Star city').length > 0 &&
        (K = [].concat(p('Star city'))).forEach(function (e) {
          o.searchStarContainer.insertAdjacentHTML('beforeend', Y()(e));
        }),
...
//# sourceMappingURL=main.351ce6dd29716af8149f.js.map
