  ...
  [0],
  {
    ...
    A2vp: function (e, n, t) {
      ...
      e.exports = (r.default || r).template({
        1: function (e, n, t, r, i) {
          ...
          return (
            '<li class="menu__item">\r\n  <article class="card">\r\n    <img\r\n      src="' +
            o(c(null != n ? s(n, 'image') : n, n)) +
            '"\r\n      alt="' +
            o(c(null != n ? s(n, 'name') : n, n)) +
            '"\r\n      class="card__image"\r\n    />\r\n    <div class="card__content">\r\n      <h2 class="card__name">' +
            o(c(null != n ? s(n, 'name') : n, n)) +
            '</h2>\r\n      <p class="card__price">\r\n        <i class="material-icons"> monetization_on </i>\r\n        ' +
            o(c(null != n ? s(n, 'price') : n, n)) +
            '\r\n      </p>\r\n\r\n      <p class="card__descr">\r\n        ' +
            o(c(null != n ? s(n, 'description') : n, n)) +
            '\r\n      </p>\r\n\r\n      <ul class="tag-list">\r\n        ' +
            (null !=
            (a = s(t, 'each').call(
              null != n ? n : e.nullContext || {},
              null != n ? s(n, 'ingredients') : n,
              {
                name: 'each',
                hash: {},
                fn: e.program(2, i, 0),
    ...
    QfWi: function (e, n, t) {
      ...
      document
        ...
        .insertAdjacentHTML('beforeend', a()(r));
      var c = function (e) {
          try {
        ...
        s = 'light-theme',
        l = 'dark-theme',
        p = document.querySelector('.theme-switch__toggle'),
        d = document.querySelector('body');
      function u() {
        d.classList.add(s), d.classList.remove(l);
      }
      function m() {
        d.classList.add(l), d.classList.remove(s);
      }
      p.addEventListener('change', function (e) {
        e.target.checked || (u(), o('Theme', s));
        e.target.checked && (m(), o('Theme', l));
      }),
        c('Theme') === s && (u(), (p.checked = !1)),
        c('Theme') === l && (m(), (p.checked = !0));
    },
  },
  [['QfWi', 1, 2]],
]);
//# sourceMappingURL=main.871fb1f3e1ef2c9a13fe.js.map
